...
forest(x = t2$estimate, ci.ub = t2$ci.high, ci.lb = t2$ci.low, 
       ...
       slab = NA, pch = 18, xlim = c(1, 2.5), 
       cex.lab = 1, cex.axis = 1.2,
       header = c("Colorectal cancer", ""))
# Number of cases
text(2.5, c(4,8, limm), c("N = 1,448 cases", "N = 1,007 cases", "N = 2,525 cases"), 
     cex = 1.5, pos = 2)
...
forest(x = t2$estimate, ci.ub = t2$ci.high, ci.lb = t2$ci.low, 
       ...
       slab = NA, pch = 18, xlim = c(0.8, 2.8), 
       cex.lab = 1, top = 2,
       #annosym = c(" (", "-", ")"),
       annosym = c(" (", " to ", ")"),
       header = c("Colon cancer", ""))

text(2.8, c(4,8, limm), c("N = 884 cases", "N = 786 cases", "N = 1,670 cases"), cex = 1.5, pos = 2)
...
text(2.9, c(4,8, limm), c("N = 564 cases", "N = 291 cases", "N = 855 cases"), cex = 1.5, pos = 2)
#dev.off()
...
forest(x = t2$estimate, ci.ub = t2$ci.high, ci.lb = t2$ci.low, 
       ...
       #annosym = c(" (", "-", ")"),
       annosym = c(" (", " to ", ")"),
       psize= 1.6, cex=1.5, slab = NA, pch = 18, xlim = c(0.8, 5.8), #alim = c(0, 3),
       cex.lab = 1)
...
forest(x = t2$estimate, ci.ub = t2$ci.high, ci.lb = t2$ci.low, 
       ...
       #annosym = c(" (", "-", ")"),
       annosym = c(" (", " to ", ")"),
       slab = NA, pch = 18, xlim = c(0.8, 4.3), #alim = c(0, 3),
       cex.axis = 1.2,
...
forest(x = t2$estimate, ci.ub = t2$ci.high, ci.lb = t2$ci.low, 
       ...
       annosym = c(" (", " to ", ")"),
       cex.axis = 1.2,
       psize= 1.6, cex=1.5, slab = NA, pch = 18, xlim = c(0.8, 6.2),  #alim = c(0,3),
       cex.lab = 1)
par("usr")
...
forest(x = t2$estimate, ci.ub = t2$ci.high, ci.lb = t2$ci.low, 
       ...
       xlab="HR (95% CI)", psize = 1.6, cex=1.5,
       slab = NA, pch = 18, xlim = c(0.8, 7.2), #alim = c(0,3),
       #annosym = c(" (", "-", ")"), 
       annosym = c(" (", " to ", ")"),
       cex.axis = 1.2,
