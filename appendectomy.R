...
url3 <- "https://docs.google.com/spreadsheets/d/16lytJkxqoelB8d-RzQFXijk9Lekfc2p5mfeaJns97YU/edit?usp=sharing"

t4 <- gsheet2tbl(url3, sheetid = 1) %>% arrange(fct_inorder(subsite), fct_inorder(group), fct_inorder(cohort)) %>% 
  mutate(std.err = ((ci.upper-ci.lower)/2)/qnorm(0.975))
