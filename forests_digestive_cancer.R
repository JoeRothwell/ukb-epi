...
# Plot for rownames
par(mar=c(5,0,0,1))
plot(1, type="n", axes = F, ann = F, ylim=c(0,34), xlim = c(0,10))
text(3, rows.lev1, labs.lev1, cex = 1.5, pos = 4, font = 2)
...
forest(x = t2$estimate, ci.ub = t2$ci.high, ci.lb = t2$ci.low, subset = t2$subsite == "colorectal_inc",
       refline=1, efac = 0, rows = rowvec, ylim=c(0,34), xlab="HR [95% CI]", 
       psize= 1.8, cex=1.5, top = 2,
...
forest(x = t2$estimate, ci.ub = t2$ci.high, ci.lb = t2$ci.low, subset = t2$subsite == "colon_inc",
       refline=1, efac = 0, rows = rowvec, ylim=c(0,34), xlab="HR [95% CI]", psize= 1.8, cex=1.5, 
...
text(2, rows.lev1, labs.lev1, cex = 1.5, pos = 4, font = 2)
...
forest(x = t2$estimate, ci.ub = t2$ci.high, ci.lb = t2$ci.low, subset = t2$subsite == "oesophad_inc",
       refline=1, efac = c(0, 0.5), rows = rowvec, ylim=c(0,35), xlab="HR [95% CI]", 
       header = c("adenocarcinoma", ""),
       psize= 1.8, cex=1.5, slab = NA, pch = 18, xlim = c(0.8, 6), alim = c(0, 3),
       cex.lab = 1)
text(0, 35, "Oesophageal", pos = 4, font = 2, cex = 1.5)
...
forest(x = t2$estimate, ci.ub = t2$ci.high, ci.lb = t2$ci.low, subset = t2$subsite == "cardstomach_inc",
       ...
       psize= 1.8, cex=1.5, slab = NA, pch = 18, xlim = c(0.8, 10),  alim = c(0,4),
       cex.lab = 1)

#rowvec <- rowvec.reset
par(mar=c(5,4,0,1))
forest(x = t2$estimate, ci.ub = t2$ci.high, ci.lb = t2$ci.low, subset = t2$subsite == "noncardstomach_inc",
       refline=1, efac = c(0, 0.5), rows = rowvec, ylim=c(0,35), xlab="HR [95% CI]", psize= 1.8, cex=1.5,
       slab = NA, pch = 18, xlim = c(0.8, 11), alim = c(0,4),
       cex.lab = 1, header = c("Stomach non-cardia", ""))

# Save as a pdf, portrait, 11 x 10 in
...
forest(x = t2$estimate, ci.ub = t2$ci.high, ci.lb = t2$ci.low, subset = t2$subsite == "hcc_inc",
       refline=1, efac = c(0, 0.5), rows = rowvec, ylim=c(0,34), xlab="HR [95% CI]", 
       header = c("Hepatocellular carcinoma",""), top = 2,
       psize= 1.8, cex=1.5, slab = NA, pch = 18, xlim = c(0.8, 16), alim = c(0,8),
       cex.lab = 1)
...
<<<<<<< HEAD
       ...
       header = c("Intrahepatic bile duct cancer", ""))
=======
       refline=1, efac = 0, rows = rowvec, ylim=c(0,34), xlab="HR [95% CI]", psize= 1.8, cex=1.5, 
       slab = NA, pch = 18, xlim = c(0.5, 12), cex.lab = 1, top = 2,
       header = c("Bile duct cancer", ""))
>>>>>>> aca8865bcb8d3d1282a2bd085d2fad61f6c6409a
...
forest(x = t2$estimate, ci.ub = t2$ci.high, ci.lb = t2$ci.low, subset = t2$subsite == "digestive_inc",
       refline=1, efac = c(0, 1), rows = rowvec, ylim=c(0,33), xlab="HR [95% CI]", 
       header = c("Total digestive cancers", "HR [95% CI]"),
       psize= 1.5, cex=0.8, 
       slab = NA,
       pch = 18, xlim = c(0, 2.2), top = 1,
       #alim = c(0,7),
       cex.lab = 0.8
       )
=======
...
forest(x = t2$estimate, ci.ub = t2$ci.high, ci.lb = t2$ci.low, subset = t2$subsite == "digestive_inc",
       refline=1, efac = c(0, 1), rows = rowvec-1, ylim=c(0,33), xlab="HR [95% CI]", 
       header = c("All digestive cancers", "HR [95% CI]"), top = 2,
       psize= 1.8, cex=1, slab = NA,
       pch = 18, xlim = c(0, 2.3), 
       #alim = c(0,7),
       cex.lab = 1)
>>>>>>> aca8865bcb8d3d1282a2bd085d2fad61f6c6409a

text(0, rows.lev1-1, labs.lev1, cex = 1, pos = 4, font = 2)
text(0.1, rows.lev2-1, labs.lev2, cex = 1, pos = 4)
text(0.2, rows.lev3-1, labs.lev3, cex = 1, pos = 4)
